...
{title: `「ღ」Rpg`, rowId: ".? rpg", description: "Mari Berpetualang Bersama ʟᴀɴʙᴏᴛᴢ!!!"},
...
{title: `「ღ」Anonymous Chats`, rowId: ".? anonymous", description: "Mengobrol Dengan Orang Yang Tidak Di Kenal"},
...
{title: `「ღ」Stikers`, rowId: ".? stiker", description: "Buat Sticker Di ʟᴀɴʙᴏᴛᴢ"},
...
{title: `「ღ」Database`, rowId: ".? database", description: "Simpan Sesuatu Di ʟᴀɴʙᴏᴛᴢ"},
{title: `「ღ」Tools`, rowId: ".? tools", description: "Mungkin Fitur Ini Bisa Membantumu"},
{title: `「ღ」Info`, rowId: ".? info", description: "Info Tentang ʟᴀɴʙᴏᴛᴢ"},
